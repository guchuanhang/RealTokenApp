...
public class NetworkUtils {
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager cm = (ConnectivityManager) RealToken.getContext()
    ...
    public static boolean getWifiEnabled() {
        WifiManager wifiManager = (WifiManager) RealToken.getContext().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
